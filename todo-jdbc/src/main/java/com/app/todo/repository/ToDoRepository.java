...
public class ToDoRepository implements CommonRepository<ToDo> {
	...
	private static final String SQL_QUERY_FIND_ALL = "select id, description, created, modified, completed "
			+ "from todo";
	...
	private static final String SQL_UPDATE = "update todo "
			+ "set description = :description, modified = :modified, completed = :completed" + "where id = :id";
