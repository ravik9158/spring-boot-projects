...
import com.app.todo.client.domain.ToDo;
import com.app.todo.client.error.ToDoErrorHandler;
...
public class ToDoRestClient {
    ...
    public ToDo setCompleted(String id) throws URISyntaxException{
        ...
        //        restTemplate.patchForObject(properties.getUrl() + properties.getBasePath() + "/{id}?_method=patch", null, ResponseEntity.class, params);
